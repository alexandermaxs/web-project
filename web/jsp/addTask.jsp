    ...
    <form action="controller" method="post" class="w3-selection w3-light-grey w3-padding">
        <table class="w3-centered">
            <tr>
                ...
                <td><input type="text" name="number" pattern="[0-9]{1,4}" class="w3-input w3-border w3-round-large"/>
                </td>
            </tr>
            <tr>
                <td><fmt:message key="page.info"/></td>
                <td><input type="text" name="info" pattern=".{5,100}" class="w3-input w3-border w3-round-large"/></td>
            </tr>
            <td><fmt:message key="page.projectId"/></td>
            <td><input type="text" name="projectId" pattern="[0-9]{1,2}" class="w3-input w3-border w3-round-large"/>
            </td>
            </tr>
            <tr>
                <td></td>
