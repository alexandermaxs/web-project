    ...
    <div class="w3-card-4">
        ...
        <form action="controller" method="post" class="w3-selection w3-light-grey w3-padding">
            <label><fmt:message key="page.login" />:
                <input type="text" name="login" value="${lastLogin}" class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br />
            </label>
            ...
            <button type="submit" class="w3-btn w3-green w3-round-large w3-margin-bottom"><fmt:message key="page.submit" /></button>
        </form>
    </div>
</div>

<div class="w3-container w3-grey w3-opacity w3-right-align w3-padding">
    <button class="w3-btn w3-round-large w3-white" onclick="location.href='..'"><fmt:message key="page.backMain" /></button>
</div>
</body>
</html>
